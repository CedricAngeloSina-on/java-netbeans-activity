 ...
 * @author _
 */
public class AdministratorChangePasswordScreen implements UserInputInterface, CredentialsInterface{
    private Scanner scanner = new Scanner(System.in);
    private int currentLoggedInUserID;
    
    public AdministratorChangePasswordScreen(int userID) {
    ...
    public void pressEnterToRedirect(Object redirect) {
        ...
        while (continueLoop) {        
            try {
                ...
                if (pressEnter.isEmpty() && (redirect instanceof AdministratorHomeScreen administratorHomeScreen)) {
                    continueLoop = false;
    ...
    public void main() {
        ...
        if (confirmation == true) {
            ...
            pressEnterToRedirect(administratorHomeScreen);
        }
        else {
