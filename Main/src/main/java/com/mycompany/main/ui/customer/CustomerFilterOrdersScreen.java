 ...
 * @author _
 */
public class CustomerFilterOrdersScreen implements UserInputInterface, FilterOrdersInterface, OrdersInterface, FilterParametersInterface{
                ...
                try {
                    ...
                    switch (intValue) {
                        ...
                        case 1:
                            ...
                            pressEnterToRedirect(customerMyOrdersScreen);
                            break;
                        case 2:
                            continueLoop = false;
    ...
    public void pressEnterToRedirect(Object redirect) {
        ...
        while (continueLoop) {        
            try {
                ...
                if (pressEnter.isEmpty() && (redirect instanceof CustomerMyOrdersScreen customerMyOrdersScreen)) {
                    continueLoop = false;
                    customerMyOrdersScreen.main();
                }
